...
import in.hridaykh.moregenerators.customTypes.ChieslItem;
import in.hridaykh.moregenerators.customTypes.FuelItem;
import in.hridaykh.moregenerators.customTypes.LedLightBulb;
import in.hridaykh.moregenerators.customTypes.LvLedLightBulb;
...
public class ModItems {
	...
	// food
	public static final DeferredItem<Item> RADISH_ITEM = ITEMS.register("radish", () -> new Item(new Item.Properties().stacksTo(67).food(ModFoodProps.RADISH)) {
		@Override
	...
	// led
	public static final DeferredItem<LvLedLightBulb> LV_LED_BULB = ITEMS.register("lv_led_bulb", () -> new LvLedLightBulb(new Item.Properties()));
	...
	public static void register(IEventBus eventBus) {
		...
		CreativeTabs.addItemToTab(LV_LED_BULB, CreativeTabs.CREATIVE_TABS[0]);
