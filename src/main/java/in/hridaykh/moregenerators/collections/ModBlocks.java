...
public class ModBlocks {
	...
	// BUILDING BLOCKS
	public static final DeferredBlock<StairBlock> BISMUTH_STAIRS = registerBlockWithItem("bismuth_stairs", () -> new StairBlock(ModBlocks.BISMUTH_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.of().strength(5f, 6).requiresCorrectToolForDrops().sound(SoundType.METAL)));
	// ORES
	...
	public static final DeferredBlock<SlabBlock> BISMUTH_SLAB = registerBlockWithItem("bismuth_slab", () -> new SlabBlock(BlockBehaviour.Properties.of().strength(5f, 6).requiresCorrectToolForDrops().sound(SoundType.METAL)));
	public static final DeferredBlock<FenceBlock> BISMUTH_FENCE = registerBlockWithItem("bismuth_fence", () -> new FenceBlock(BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops()));
	public static final DeferredBlock<FenceGateBlock> BISMUTH_FENCE_GATE = registerBlockWithItem("bismuth_fence_gate", () -> new FenceGateBlock(WoodType.ACACIA, BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops()));
	public static final DeferredBlock<WallBlock> BISMUTH_WALL = registerBlockWithItem("bismuth_wall", () -> new WallBlock(BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops()));
	// REDSTONE
	public static final DeferredBlock<PressurePlateBlock> BISMUTH_PRESSURE_PLATE = registerBlockWithItem("bismuth_pressure_plate", () -> new PressurePlateBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(5f, 6).requiresCorrectToolForDrops().sound(SoundType.METAL)));
	public static final DeferredBlock<ButtonBlock> BISMUTH_BUTTON = registerBlockWithItem("bismuth_button", () -> new ButtonBlock(BlockSetType.IRON, 3, BlockBehaviour.Properties.of().strength(5f, 6).requiresCorrectToolForDrops().sound(SoundType.METAL).noCollission()));
	public static final DeferredBlock<DoorBlock> BISMUTH_DOOR = registerBlockWithItem("bismuth_door", () -> new DoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops().noOcclusion()));
	public static final DeferredBlock<TrapDoorBlock> BISMUTH_TRAPDOOR = registerBlockWithItem("bismuth_trapdoor", () -> new TrapDoorBlock(BlockSetType.IRON, BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops().noOcclusion()));
	// --------
